...
export function Gallery() {
  ...
  return (
    <section id="galeria" className="bg-ink py-20 text-white md:py-28">
      <div className="container-shell relative z-10">
        ...
        <ScrollReveal className="mt-8 flex flex-wrap items-center gap-2" role="group" aria-label="Filtrar galería">
      ...
      <div className="mt-6">{useFallback ? <div className="container-shell"><GalleryFallback items={filtered} onSelectItem={handleSelectItem} /></div> : <GalleryRibbon items={filtered} onContextLost={handleContextLost} onSelectItem={handleSelectItem} />}</div>
