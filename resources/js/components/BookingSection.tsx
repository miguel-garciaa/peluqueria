    ...
    <section id="reservas" className="section-space bg-ink text-white">
      <div className="container-shell">
        ...
        <ScrollReveal className="grid overflow-hidden rounded-2xl bg-porcelain text-ink fine-shadow lg:grid-cols-[.88fr_1.12fr]">
          <div className="flex flex-col bg-charcoal p-6 text-white sm:p-10">
            ...
            >
              ...
              <span className="absolute bottom-4 left-4 flex items-center gap-2 rounded-md bg-ink/80 px-3 py-2 text-xs font-semibold text-white backdrop-blur-sm">
                Ver en Google Maps
        ...
        <div className="mt-8 flex justify-end">
          <a href="#inicio" className="group inline-flex min-h-11 items-center gap-3 rounded-md border border-white/20 px-3 py-2 pr-5 text-sm font-bold text-white/80 outline-none transition-[background-color,color,border-color,transform] hover:-translate-y-0.5 hover:border-white hover:bg-white hover:text-ink focus-visible:ring-2 focus-visible:ring-brass focus-visible:ring-offset-4 focus-visible:ring-offset-ink">
