...
export function MyAppointmentsPage({ currentUser, appointments, csrfToken, flash }: AppointmentsPageProps) {
      ...
      <main id="appointments-content" className="min-h-screen bg-porcelain pb-24 pt-32 text-ink lg:pt-40">
        <section className="container-shell">
          <div className="border-b border-ink/12 pb-10 lg:flex lg:items-end lg:justify-between">
            ...
            <a href="/#reservas" className="group mt-7 inline-flex min-h-14 items-center gap-3 rounded-full bg-ink p-2 pr-6 font-bold text-white transition-transform hover:-translate-y-0.5 lg:mt-0">
          ...
          {appointments.length === 0 ? (
            <div className="mt-10 grid min-h-80 place-items-center rounded-2xl border border-dashed border-ink/20 bg-white p-8 text-center">
              <div>
                ...
                <a href="/#reservas" className="mt-6 inline-flex rounded-full bg-ink px-6 py-3.5 font-bold text-white">Reservar mi primera cita</a>
              </div>
            </div>
          ) : (
